 ...
 */
public class PercentComparatorLowHigh implements Comparator<Drink> {
    /**
     * Compares the alcohol percentage of two drinks
     * @param d1 drink one
     * @param d2 drink two
     * @return the percentage difference for the Collection.sort functions (low to high sorting)
     */
    @Override
